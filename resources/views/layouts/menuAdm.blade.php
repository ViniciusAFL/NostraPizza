                ...
                <div class="col-12">
                    <nav class="navbar d-none d-sm-block" id="background-nav">
                        <form class="container-fluid justify-content-center ">
                            ...
                            <button class="btn me-2 " id="btn-color" type="button">
                                <a class="nav-link" href="{{ route('gerente.index') }}">Lista de Gerentes</a>
                            </button>
                            <button class="btn me-2 " id="btn-color" type="button">
                                <a class="nav-link" href="{{ route('user.create')}}">Cadastro de Pião</a>
                            </button>
                            <button class="btn me-2" id="btn-color" type="button">
                                <a class="nav-link" href="{{ route('cargo.index') }}">Lista de Funcionarios</a>
                            </button>
                        ...
                        <div class="btn-dropdown d-sm-none ">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><a class="dropdown-item" href="promocao.php">Clientes</a></li>
                                    <li><a class="dropdown-item" href="cardapio.php">Cadastro</a></li>
                                    <li><a class="dropdown-item" href="bebidas.php">Funcionários</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
