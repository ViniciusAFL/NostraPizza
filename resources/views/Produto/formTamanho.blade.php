...
@section('conteudo')
    ...
    <div class="container">
        ...
        <div class="container cont-prod-tamanho">

            <h1 class="p-3"> Produto: {{ $produto->nome }}</h1>
            <h2>
            ...
            <form
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input class="form-control" type="number" name="preco" id="preco" step="0.01"
                            min="0" value="{{ $produtoTamanho ? $produtoTamanho->preco : old('preco') }}" required>
                    </div>
                ...
                @else
                    <input class="btn btn-clientes mt-4" type="submit" value="Cadastrar Tamanho Produto">
                @endif
